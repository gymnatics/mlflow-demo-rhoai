...
This policy establishes the requirements for Customer Due Diligence (CDD) and Anti-Money Laundering (AML) compliance in accordance with the Anti-Money Laundering and Countering Financing of Terrorism Act 2009 (AML/CFT Act) and associated regulations.

## 2. Customer Identification and Verification

### 2.1 Standard CDD (Individual Customers)
...
### 2.2 Standard CDD (Business Customers)
...
- Customer is a Politically Exposed Person (PEP) — domestic or foreign.
- Customer is from a high-risk jurisdiction as defined by the FATF grey or black list.
- Complex or unusual transaction patterns that have no apparent economic purpose.
- Correspondent banking relationships.
- New technologies or delivery channels where identity verification is limited.
...
- Ongoing review at least every 12 months.
...
- The Bank operates automated transaction monitoring systems that flag transactions based on risk-based rules and scenarios.
- Alerts must be reviewed and dispositioned within 5 working days.
- False positive rates are reviewed quarterly to optimise detection rules.

## 4. Politically Exposed Persons (PEPs)

### 4.1 Identification

- All customers must be screened against PEP databases at onboarding and on an ongoing basis.
- PEP screening must cover the customer, beneficial owners, and connected parties.
- Screening must include both domestic and foreign PEPs.

### 4.2 Management of PEP Relationships

- PEP relationships require senior management approval.
- Source of wealth and source of funds must be established and documented.
- Enhanced ongoing monitoring is mandatory.
- PEP status must be reviewed at least annually.
...
- All CDD records must be retained for a minimum of 5 years after the end of the customer relationship.
- Transaction records must be retained for a minimum of 5 years after the transaction date.
- Records must be sufficient to reconstruct each transaction and demonstrate compliance with the AML/CFT Act.
- Records may be stored electronically provided they are readily retrievable.
